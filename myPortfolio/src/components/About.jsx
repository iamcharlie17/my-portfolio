...
const About = () => {
  return (
    <div id="about">
      <div className="flex my-12 md:my-24 flex-col lg:flex-row md:mx-16 lg:mx-24 mx-4 gap-8 items-center ">
        <div className="flex-1 ">
          <h1>Profile Picture</h1>
          {/* <img src={profile} alt="" /> */}
        </div>
        <div className="text-white md:space-y-16 space-y-8 flex-1">
          <div className="md:text-4xl text-2xl font-semibold space-y-2 md:space-y-4 text-gray-200 font-kaushan">
          ...
          <div>
            <button className="uppercase bg-gray-600 px-4 py-1  transition-transform hover:text-yellow-500 rounded-sm">
              Download resume
            </button>
